...
> {
  ...
  constructor(
    @inject('datasources.confedata') dataSource: ConfedataDataSource, @repository.getter('CommentRepository') protected commentRepositoryGetter: Getter<CommentRepository>,
  ) {
